Una empresa conoce el nombre, sueldo y categoría de sus empleados, son 4 categorías, y la cantidad de empleados es variable N. Se desea saber:
...
int main(void) 
{
  ...
  printf ("La cantidad de sueldos que superan los $2000 son: %d", b);
  printf ("\n");
  auxc = may1000(categoria, sueldo, x); //Punto C
  printf ("La cantidad de empleados de cat1 con sueldo superiror a los $1000 son: %d", auxc);
  printf ("\n");
...
void catemp (int categoria [], int x, int cat1, int cat2, int cat3, int cat4 )
{
  ...
  printf ("\n");
  printf ("La cantidad de empleados por categoria son: \n");
...
void suelmax (char nombres [] [20], int sueldos [], int x)
{
  ...
  printf ("%s posee el mayor sueldo: $%d", suelmax, max);
  printf ("\n");
}
...
void suelmin (char nombres [] [20], int sueldos [], int x)
{
  ...
  printf ("%s posee el menor sueldo: $%d", suelmax, min);
  printf ("\n");
}
...
void porcentaje (int cat1, int cat2, int cat3, int cat4, int x)
{
  ...
  por3 = (cat3 * 100) / x;
  por4 = (cat4 * 100) / x;
  printf ("El porcentaje de empleados por categoria corresponde a: \n");
  printf ("Categoría 1:  %%%d", por1);
  printf ("Categoría 2:  %%%d", por2);
  printf ("Categoría 3:  %%%d", por3);
  printf ("Categoría 4:  %%%d", por4);
}
