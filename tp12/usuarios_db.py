...
def lista_usuarios_por_Puntajes():
    ...
    while linea != "":
        ...
        linea_split += str(linea_secundaria[ 1 ])
        linea_split += ","
        linea_split += str(linea_secundaria[ 3 ].rstrip())
        lineasplit = linea_split.split(" , ")
        archivo_original.append( lineasplit )
        linea = archivo.readline()
    archivo.close()
